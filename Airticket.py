...
def process(flight_data,stopNo,min_price,max_price):
    ...
    try:
    	  for i in flight_data['legs'].keys():
    		  ...
    		  departure_location_airport = flight_data['legs'][i].get('timeline',{}).get('departureAirport',{}).get('longName','')
    		  departure_location_city = flight_data['legs'][i].get('departureLocation',{}).get('airportCity','')
    		  arrival_location_airport = flight_data['legs'][i].get('timeline',{}).get('arrivalAirport',{}).get('longName','')
